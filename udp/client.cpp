...
int main(int argc, char* argv[])
{
  try
  {
    ...
    boost::asio::posix::stream_descriptor output(io_context, ::dup(STDOUT_FILENO));

    rawudp::resolver resolver(io_context);
    rawudp::resolver::results_type endpoints =
    ...
    rawudp::socket socket(io_context);
    socket.bind(*endpoints.endpoint);
